...
| 范围 | 路径 |
|---|---|
| 工作区 | `.gemini/skills/<skill-name>/SKILL.md` |
| 用户 | `~/.gemini/skills/<skill-name>/SKILL.md` |
| 扩展 | 扩展包内 |
...
| 范围 | 路径 |
|---|---|
| REPO (CWD) | `$CWD/.agents/skills/<skill-name>/` |
| REPO (上级) | `$CWD/../.agents/skills/<skill-name>/` |
| REPO (根) | `$REPO_ROOT/.agents/skills/<skill-name>/` |
| USER | `$HOME/.agents/skills/<skill-name>/` |
| ADMIN | `/etc/codex/skills/<skill-name>/` |
| SYSTEM | Codex 内置 |
...
| 单文件遗留格式 | `.claude/commands/*.md` | 无 | 无 |
