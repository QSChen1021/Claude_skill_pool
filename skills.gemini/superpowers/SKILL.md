...
**Path conventions by runtime (Gemini):**
All supporting files are siblings of this `SKILL.md` within the skill directory.
- TDD checklist: `scripts/tdd-checklist.md`
- Quick reference: `references/quick-start.md`
- Design template: `templates/design-spec-template.md`
- Plan template: `templates/implementation-plan-template.md`
